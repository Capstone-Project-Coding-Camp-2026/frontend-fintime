    ...
    <>
      ...
      >
        ...
        <Link to="/" className="flex items-center gap-2 no-underline">
          ...
          <span
            className="hidden md:inline-block text-xs font-mono px-2 py-0.5 rounded-full ml-1"
            style={{
          ...
          >
            {[0, 1, 2].map(i => (
              <motion.span
                ...
                style={{ display: 'block', width: 24, height: 1.5, background: '#00f5ff', borderRadius: 1 }}
              />
            ))}
          </button>
        </div>
      ...
      >
        {NAV_LINKS.map((link) => (
          <button
            ...
            style={{ color: 'var(--text-muted)', background: 'none', border: 'none', fontFamily: 'Sora, sans-serif' }}
          >
            {link.label}
          </button>
        ))}
