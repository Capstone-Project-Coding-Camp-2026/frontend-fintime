      ...
      >
        ...
        <div className="flex items-center justify-between p-5 border-b" style={{ borderColor: 'rgba(0, 245, 255, 0.08)' }}>
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold" style={{ color: 'var(--text)' }}>Akun Terhubung</h3>
              <p className="text-xs" style={{ color: 'var(--text-muted)' }}>{accounts.length} akun</p>
            </div>
          </div>
          <button
            onClick={onAddNew}
            className="px-3 py-1.5 rounded-lg text-xs font-medium transition-all hover:bg-cyan-500/20"
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-sm" style={{ color: 'var(--text)' }}>{account.name}</p>
