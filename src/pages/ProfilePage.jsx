      ...
      {({ user: layoutUser, handleLogout }) => (
        <main className="pt-24 relative z-10 pb-20">
          ...
          <div
            ...
            style={{ background: 'linear-gradient(135deg, #061528 0%, #020b18 100%)', border: '1px solid rgba(0,245,255,0.1)' }}
          >
            <div
                  ...
                  <div className="text-center lg:text-left flex-1">
                    ...
                    <div className="flex flex-wrap justify-center lg:justify-start gap-3">
                      <span className="px-4 py-2 rounded-xl text-sm font-semibold" style={{
                        ...
                        {((user || layoutUser)?.jobType || (user || layoutUser)?.occupation) ? ((user || layoutUser)?.jobType || (user || layoutUser)?.occupation).charAt(0).toUpperCase() + ((user || layoutUser)?.jobType || (user || layoutUser)?.occupation).slice(1).replace(/_/g, ' ') : 'Investor'}
                      </span>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 rounded-xl" style={{ background: 'rgba(0,245,255,0.03)', border: '1px solid rgba(0,245,255,0.08)' }}>
                      ...
                      <span className="font-semibold">
                        {(user || layoutUser)?.createdAt ? new Date((user || layoutUser).createdAt).toLocaleDateString('id-ID', { month: 'short', year: 'numeric' }) : 'N/A'}
                      </span>
                    </div>
                    <div className="flex items-center justify-between p-4 rounded-xl" style={{ background: 'rgba(0,245,255,0.03)', border: '1px solid rgba(0,245,255,0.08)' }}>
                      <div className="flex items-center gap-3">
